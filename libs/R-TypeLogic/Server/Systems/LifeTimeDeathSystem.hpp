...
namespace rtypelogic
{
    ...
    namespace server
    {
        ...
        /// This System takes all entities that have a LifeTime Component with 0 timeLeft or less and adds a Death
        /// Component to them. It's a system that will be called by the engine world with the function runSystem()
